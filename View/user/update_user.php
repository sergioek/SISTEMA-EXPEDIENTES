...
<!----Comienza formulario con los campos se usa una tabla para su formato-------->
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
        <table class="table container col-lg-8 offset-lg-3">
            ...
            <tr>
                <td><input class="form-control col-lg-8" type="date" name="date" id="date" min="1950-01-01" max="2005-01-01" placeholder="Seleccione una fecha" required value="<?php echo $date;?>"></td>
            </tr>
