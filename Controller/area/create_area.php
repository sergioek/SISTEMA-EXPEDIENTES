...
//Si todas las validaciones son verdaderas se incorpora el archivo para hacer la insercion            
            if($v1 && $v2 && $v3&& $v4 && $v5==TRUE){
                ...
                require_once($_SERVER['DOCUMENT_ROOT']."/SISTEMA EXPEDIENTES/Model/area/insert_new_area.php");
                
                echo'<script language="javascript">alert("Área creada con éxito.");</script>';
                }catch(Exception $e){
                    echo'<script language="javascript">alert("Error al crear un área.");</script>';}
