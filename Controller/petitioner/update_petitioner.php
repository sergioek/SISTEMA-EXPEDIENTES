    ...
    public function __construct(){
        ...
        if(isset($_POST["update"])){
            ...
            if($v1 && $v2 && $v3&& $v4 && $v5 && $v6==TRUE){
                ...
                include($_SERVER['DOCUMENT_ROOT']."/SISTEMA EXPEDIENTES/Model/petitioner/update_new_petitioner.php");
                }catch(Exception $e){
                    echo'<script language="javascript">alert("Error al actualizar.Verifique que los datos sean correctos.");</script>';}
