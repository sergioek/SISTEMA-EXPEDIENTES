...
$consulta="UPDATE OPERADORES SET NOMBRES=?,FECHANACIMIENTO=?,DOMICILIO=?,CONTRASEÑA=?,AREA=?,CARGO=?,TELEFONO=?,CORREO=? WHERE DNI=?";
//
...
$resultado->bindParam(7,$telephone,PDO::PARAM_INT);
$resultado->bindParam(8,$email,PDO::PARAM_STR);
$resultado->bindParam(9,$dni,PDO::PARAM_INT);
